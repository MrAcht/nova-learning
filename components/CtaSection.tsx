      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <ul className="space-y-2 mb-6">
            <li className="flex items-center"><CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-[#2f795e]" /> <span className="text-sm sm:text-base">Prenez rendez-vous</span></li>
            <li className="flex items-center"><CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-[#2f795e]" /> <span className="text-sm sm:text-base">On discute de votre projet</span></li>
            <li className="flex items-center"><CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-[#2f795e]" /> <span className="text-sm sm:text-base">Et on peut commencer à travailler !</span></li>
          </ul>
        </div>
        <div className="bg-gray-100 p-4 rounded-lg">
          <div className="text-center p-4 sm:p-8">
            <CalendarIcon className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 text-[#2f795e]" />
            <h3 className="text-lg sm:text-xl font-bold mb-4">Choisissez un jour</h3>
